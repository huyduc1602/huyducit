...
class Laundry_Master_Loader {
	 ...
	 * @return void
	 */
	public function laundry_master_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function laundry_master_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function laundry_master_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function laundry_master_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->laundry_master_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function laundry_master_load( $class ) {
